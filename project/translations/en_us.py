dictionary = {
    ...
    'general': {
        'yes': 'Yes',
        'no': 'No',
        'credits': 'Made with ♥ by vinibiavatti1',
        'actions': 'Actions',
        'form': 'Form',
        'welcome': 'Welcome!',
        'idiom': 'Idiom',
        'noscript': 'You need Javascript enabled to use this website!',
    },
    'feedbacks': {
    ...
    'forms': {
        'example': {
            'f1': {
                'label': 'Text field',
                'placeholder': 'Put the text content'
            },
            'f2': {
                'label': 'Numeric field',
                'placeholder': 'Put the number content'
            },
            'f3': {
